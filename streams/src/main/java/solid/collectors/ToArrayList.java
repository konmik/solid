...
public class ToArrayList {
     ...
     */
    public static <T> Func1<Iterable<T>, ArrayList<T>> toArrayList() {
     ...
     */
    public static <T> Func1<Iterable<T>, ArrayList<T>> toArrayList(final int initialCapacity) {
        return new Func1<Iterable<T>, ArrayList<T>>() {
            @Override
