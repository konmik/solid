...
public class ToArrayListTest {
    ...
    public void testNewAndCall() throws Exception {
        assertIterableEquals(Arrays.asList(1, 2, 3), new ToArrayList<Integer>().call(Arrays.asList(1, 2, 3)));
        assertIterableEquals(Collections.<Integer>emptyList(), new ToArrayList<Integer>().call(Collections.<Integer>emptyList()));
        assertIterableEquals(Arrays.asList(1, 2, 3), new ToArrayList<Integer>(10).call(Arrays.asList(1, 2, 3)));
        assertIterableEquals(Collections.<Integer>emptyList(), new ToArrayList<Integer>(10).call(Collections.<Integer>emptyList()));
    }
}