...
public class MockSparseArray {
    ...
    public static void powerMockNew() throws Exception {
        whenNew(SparseArray.class).withAnyArguments().thenAnswer(new Answer<SparseArray>() {
            @Override
            public SparseArray answer(InvocationOnMock invocation) throws Throwable {
                return new MockSparseArray().getMockedSparseArray();
            }
        });
    }
